...
TRADE_SYMBOLS = [
    ...
    "GALAUSDT","ICPUSDT","LSKUSDT","XLMUSDT","TIAUSDT",
    ...
    "OXTUSDT","PEOPLEUSDT","BLZUSDT","LUNA2USDT","XTZUSDT",
    "LRCUSDT","ZILUSDT","NTRNUSDT","POLYXUSDT","HOTUSDT",
    "AXSUSDT","STEEMUSDT","LPTUSDT","TUSDT","SUIUSDT","STXUSDT",
    "GASUSDT","MKRUSDT","NKNUSDT","HOOKUSDT","MKRUSDT","FLMUSDT",
    "STXUSDT","DOTUSDT","STORJUSDT","DASHUSDT","PERPUSDT","STGUSDT",
